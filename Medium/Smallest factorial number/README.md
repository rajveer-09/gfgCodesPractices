<h2><a href="https://practice.geeksforgeeks.org/problems/smallest-factorial-number5929/1?page=1&difficulty[]=-1&difficulty[]=0&difficulty[]=1&difficulty[]=2&category[]=Prime%20Number&category[]=Numbers&category[]=number-theory&category[]=series&category[]=palindrome&category[]=pattern-printing&category[]=Fibonacci&category[]=factorial&category[]=Operators&category[]=Data%20Type&category[]=CPP-Control-Flow&sortBy=submissions">Smallest factorial number</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a number&nbsp;<strong>n</strong>. The task is to find the smallest number whose factorial contains at least n trailing zeroes.</span></p>
