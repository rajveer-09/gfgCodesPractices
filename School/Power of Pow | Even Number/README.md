<h2><a href="https://practice.geeksforgeeks.org/problems/power-of-pow-even-number5440/1?page=2&difficulty[]=-2&category[]=Arrays&category[]=Prime%20Number&category[]=Numbers&category[]=number-theory&category[]=series&category[]=palindrome&category[]=pattern-printing&category[]=Data%20Type&sortBy=submissions">Power of Pow | Even Number</a></h2><h3>Difficulty Level : School</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a single integer <strong>N</strong>, your task is to find the sum of the square of the first <strong>N even natural Numbers</strong>.</span><br>
&nbsp;</p>
